...
size_t cbase64_encode_block(const unsigned char* data_in, unsigned int length_in,
                                  char* code_out, cbase64_encodestate* state_in);

size_t cbase64_decode_block(const char* code_in, unsigned int length_in,
                                  unsigned char* data_out, cbase64_decodestate* state_in);

size_t cbase64_encode_blockend(char* code_out, cbase64_encodestate* state_in);
